...
const (
	// Label holds the string label denoting the vehicledata type in the database.
	Label = "vehicle_data"
	...
	// Table holds the table name of the vehicledata in the database.
	Table = "vehicle_data"
)

// Columns holds all SQL columns for vehicledata fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the VehicleData queries.
