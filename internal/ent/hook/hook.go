...
// The PoliceStationFunc type is an adapter to allow the use of ordinary
// function as PoliceStation mutator.
type PoliceStationFunc func(context.Context, *ent.PoliceStationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PoliceStationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PoliceStationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PoliceStationMutation", m)
}
...
// The VehicleDataFunc type is an adapter to allow the use of ordinary
// function as VehicleData mutator.
type VehicleDataFunc func(context.Context, *ent.VehicleDataMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VehicleDataFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VehicleDataMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VehicleDataMutation", m)
}
