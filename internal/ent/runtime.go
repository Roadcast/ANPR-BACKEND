...
func init() {
	...
	// vehicledataDescID is the schema descriptor for id field.
	vehicledataDescID := vehicledataMixinFields0[0].Descriptor()
	// vehicledata.DefaultID holds the default value on creation for the id field.
	vehicledata.DefaultID = vehicledataDescID.Default.(func() uuid.UUID)
}
